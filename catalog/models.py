...
class Course(models.Model):
	...
	organization_img = models.URLField()
...
class Content(models.Model):
	...
	subtitle = models.URLField(null=True, blank=True)
	subtitle_ru = models.URLField(null=True, blank=True)
	supplementary_materials = models.URLField(null=True, blank=True)
